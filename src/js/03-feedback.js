...
// emailEl.addEventListener('input', onInputForm);
...
function onSubmitForm(event){
  ...
  const data = {};
    ...
    function onInputForm(event){
        // const dataLocal = JSON.parse(localStorage.getItem(FORMS_KEY));
        // const data = {[event.target.name]:event.target.value, ...dataLocal};
